...
fn player_movement_system(
    ...
    translation.x += xdirection * player.speed * TIME_STEP;
    // move the player vertically
    translation.y += ydirection * player.speed * TIME_STEP;
    // bound the player within the walls
    translation.x = translation.x.min(435.0).max(-435.0);
    translation.y = translation.y.min(285.0).max(-285.0);
}
